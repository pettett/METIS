...
#[no_mangle]
pub unsafe extern "C" fn encodeblock(
    ...
    *out
        ...
        | *in_0.offset(1 as libc::c_int as isize) as libc::c_int >> 4 as libc::c_int)
        as libc::c_uchar;
    *out
        .offset(
