...
pub unsafe extern "C" fn errexit(mut f_str: *mut libc::c_char, mut args: ...) {
    ...
    if strlen(f_str) == 0 as libc::c_int as libc::c_ulong
        || *f_str
            .offset(
                (strlen(f_str)).wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize,
            ) as libc::c_int != '\n' as i32
    {
...
pub unsafe extern "C" fn gk_sigtrap() -> libc::c_int {
    ...
    gk_cur_jbufs += 1;
    gk_cur_jbufs;
    old_SIGMEM_handlers[gk_cur_jbufs
        as usize] = signal(
        6 as libc::c_int,
        Some(gk_sigthrow as unsafe extern "C" fn(libc::c_int) -> ()),
    );
    old_SIGERR_handlers[gk_cur_jbufs
        as usize] = signal(
        15 as libc::c_int,
        Some(gk_sigthrow as unsafe extern "C" fn(libc::c_int) -> ()),
    );
...
pub unsafe extern "C" fn gk_siguntrap() -> libc::c_int {
    ...
    signal(15 as libc::c_int, old_SIGERR_handlers[gk_cur_jbufs as usize]);
    gk_cur_jbufs -= 1;
    gk_cur_jbufs;
    return 1 as libc::c_int;
}
