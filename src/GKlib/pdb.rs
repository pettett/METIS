...
pub unsafe extern "C" fn gk_threetoone(mut res: *mut libc::c_char) -> libc::c_char {
    *res
        ...
        {
            if 0 != 0 {
                let mut __c: libc::c_int = *res.offset(0 as libc::c_int as isize)
                    as libc::c_int;
    ...
    *res
        ...
        {
            if 0 != 0 {
                let mut __c: libc::c_int = *res.offset(1 as libc::c_int as isize)
                    as libc::c_int;
                __res = if __c < -(128 as libc::c_int) || __c > 255 as libc::c_int {
                    __c
                } else {
    ...
    *res
        ...
        {
            if 0 != 0 {
                let mut __c: libc::c_int = *res.offset(2 as libc::c_int as isize)
                    as libc::c_int;
                __res = if __c < -(128 as libc::c_int) || __c > 255 as libc::c_int {
                    __c
                } else {
    ...
    } else if strcmp(res, b"CYS\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'C' as i32 as libc::c_char
    } else if strcmp(res, b"ASP\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'D' as i32 as libc::c_char
    } else if strcmp(res, b"GLU\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'E' as i32 as libc::c_char
    } else if strcmp(res, b"PHE\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'F' as i32 as libc::c_char
    } else if strcmp(res, b"GLY\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'G' as i32 as libc::c_char
    } else if strcmp(res, b"HIS\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'H' as i32 as libc::c_char
    } else if strcmp(res, b"ILE\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'I' as i32 as libc::c_char
    } else if strcmp(res, b"LYS\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'K' as i32 as libc::c_char
    } else if strcmp(res, b"LEU\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'L' as i32 as libc::c_char
    } else if strcmp(res, b"MET\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'M' as i32 as libc::c_char
    } else if strcmp(res, b"ASN\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'N' as i32 as libc::c_char
    } else if strcmp(res, b"PRO\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'P' as i32 as libc::c_char
    } else if strcmp(res, b"GLN\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'Q' as i32 as libc::c_char
    } else if strcmp(res, b"ARG\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'R' as i32 as libc::c_char
    } else if strcmp(res, b"SER\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'S' as i32 as libc::c_char
    } else if strcmp(res, b"THR\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'T' as i32 as libc::c_char
    } else if strcmp(res, b"SCY\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'U' as i32 as libc::c_char
    } else if strcmp(res, b"VAL\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'V' as i32 as libc::c_char
    } else if strcmp(res, b"TRP\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 'W' as i32 as libc::c_char
    } else if strcmp(res, b"TYR\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
    ...
    if !p.is_null() {
        ...
        while i < (*p).natoms {
            gk_free(
                ...
                &mut (*((*p).atoms).offset(i as isize)).resname
...
pub unsafe extern "C" fn gk_readpdbfile(mut fname: *mut libc::c_char) -> *mut pdbf {
    ...
    let mut aname: [libc::c_char; 5] = *::core::mem::transmute::<
        &[u8; 5],
        &mut [libc::c_char; 5],
    >(b"    \0");
    let mut altLoc: libc::c_char = ' ' as i32 as libc::c_char;
    let mut rname: [libc::c_char; 4] = *::core::mem::transmute::<
        &[u8; 4],
        &mut [libc::c_char; 4],
    >(b"   \0");
    ...
    let mut toFill: *mut pdbf = gk_malloc(
        ::core::mem::size_of::<pdbf>() as libc::c_ulong,
    ...
    while !(fgets(line.as_mut_ptr(), 256 as libc::c_int, FPIN)).is_null() {
            ...
            .is_null()
        {
            ...
            atoms += 1;
            atoms;
            if strcmp(aname.as_mut_ptr(), b"CA\0" as *const u8 as *const libc::c_char)
                == 0 as libc::c_int
            {
                cas += 1;
                cas;
            }
            if strcmp(aname.as_mut_ptr(), b"N\0" as *const u8 as *const libc::c_char)
                == 0 as libc::c_int
                || strcmp(
                    aname.as_mut_ptr(),
                    b"CA\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                || strcmp(aname.as_mut_ptr(), b"C\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
                || strcmp(aname.as_mut_ptr(), b"O\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
            {
                bbs += 1;
                bbs;
    ...
    (*toFill)
        .atoms = gk_malloc(
        (atoms as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<atom>() as libc::c_ulong),
        b"atoms\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) as *mut atom;
    (*toFill)
        .bbs = gk_malloc(
        (bbs as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<*mut atom>() as libc::c_ulong),
    ...
    (*toFill)
        .cm = gk_malloc(
        (residues as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<center_of_mass>() as libc::c_ulong),
    ...
    while !(fgets(line.as_mut_ptr(), 256 as libc::c_int, FPIN)).is_null() {
            ...
            .is_null()
        {
            ...
            if firstres == 1 as libc::c_int {
                *((*toFill).resSeq)
                    .offset(res as isize) = gk_threetoone(rname.as_mut_ptr());
            ...
            if oldRserial != rserial {
                (*((*toFill).cm).offset((res - 1 as libc::c_int) as isize))
                    .x = avgx / nresatoms as libc::c_double;
                (*((*toFill).cm).offset((res - 1 as libc::c_int) as isize))
                    .y = avgy / nresatoms as libc::c_double;
                (*((*toFill).cm).offset((res - 1 as libc::c_int) as isize))
                    .z = avgz / nresatoms as libc::c_double;
                avgx = 0.0f64;
                avgy = 0.0f64;
                avgz = 0.0f64;
                nresatoms = 0 as libc::c_int;
                (*((*toFill).cm).offset((res - 1 as libc::c_int) as isize))
                    .name = *((*toFill).resSeq)
                    .offset((res - 1 as libc::c_int) as isize);
...
#[no_mangle]
pub unsafe extern "C" fn gk_writefastafrompdb(
    mut pb: *mut pdbf,
...
#[no_mangle]
pub unsafe extern "C" fn gk_writecentersofmass(
    mut p: *mut pdbf,
    mut fname: *mut libc::c_char,
) {
    let mut i: libc::c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn gk_writefullatom(
    mut p: *mut pdbf,
    mut fname: *mut libc::c_char,
) {
    let mut i: libc::c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn gk_writebackbone(
    mut p: *mut pdbf,
    mut fname: *mut libc::c_char,
) {
    let mut i: libc::c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn gk_writealphacarbons(
    mut p: *mut pdbf,
    mut fname: *mut libc::c_char,
) {
    let mut i: libc::c_int = 0;
